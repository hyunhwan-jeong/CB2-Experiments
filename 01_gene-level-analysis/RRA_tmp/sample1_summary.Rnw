...
library(xtable)
comparisons=c("A1,A2,A3_vs_B1,B2,B3 neg.","A1,A2,A3_vs_B1,B2,B3 pos.");
ngenes=c(93,93);
...
\newpage\section{Comparison results of A1,A2,A3 vs B1,B2,B3 neg.}

The following figure shows the distribution of RRA score in the comparison A1,A2,A3 vs B1,B2,B3 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of A1,A2,A3 vs B1,B2,B3 pos.}

The following figure shows the distribution of RRA score in the comparison A1,A2,A3 vs B1,B2,B3 pos., and the RRA scores of 10 genes.
